...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.piclabel_4 = QtWidgets.QLabel(self.centralwidget)#piclabel:labels that are used to show pictures of the upgrade materials
        ...
        self.textlabel_3 = QtWidgets.QLabel(self.centralwidget)#textlabel:labels that are used to show texts of the upgrade materials
        ...
        self.calendarWidget = QtWidgets.QCalendarWidget(self.centralwidget)#calendar
        ...
        self.developlist=readcsv('D:\\GenshinCalendar\\data.csv')#read developlist from the file
        ...
        self.listView = QtWidgets.QListView(self.centralwidget)#list that is used to show developlist today
        ...
        self.remove_button = QtWidgets.QPushButton(self.centralwidget)#remove one character from the developlist
        ...
        self.starchoose = QtWidgets.QComboBox(self.centralwidget)#choose 4-star or 5-star characters
        ...
        self.list1=getnamelist()#show name list and select characters
        ...
        self.add_button = QtWidgets.QPushButton(self.centralwidget)#add one character to the developlist
        ...
        self.searchitems_button = QtWidgets.QPushButton(self.centralwidget)#serach the upgrade materials of the character
        ...
        self.starchoose.currentIndexChanged.connect(self.namelistchange)#when you choose one:4-star or 5-star
        self.searchitems_button.clicked.connect(self.search)#when you click the search button
        self.add_button.clicked.connect(self.add)#when you click the add button
        self.calendarWidget.clicked[QtCore.QDate].connect(self.switchdate)#when you select a date
        self.remove_button.clicked.connect(self.remove)#when you click the remove button
    ...
    def namelistchange(self):#switch from 5-star to 4-star or 4-star to 5-star
        self.namelist.clear()
    ...
    def showpictures(self,name):#show the upgrade materials to users
    ...
    def search(self):#search the upgrade materials of the selected character and show it to users
        material_list=search_items(self.namelist.currentText())
        downloadpic(material_list)
        name=material_list[3]
        self.showpictures(name)
        
    def add(self):#add the character from the develop list
    ...
    def getdatetype(self):#get the date that users selected
    ...
    def showtodaylist(self):#show the characters users need to develop today
        self.develop_show=showdeveloplist(self.developlist,self.weekdaytype)
        slm=QStringListModel()
        slm.setStringList(self.develop_show)
        self.listView.setModel(slm)
            
    def switchdate(self):#when you switch the date, change the contents show in the list
        self.getdatetype()
        self.showtodaylist()
        
    def remove(self):#remove the character from the develop list
        try:
